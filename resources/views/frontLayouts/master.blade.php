    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="{{ route('site.team') }}" class="nav-item nav-link">Team</a>
            ...
            @guest
                <a href="{{ route('login') }}" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">Login / Join Now<i class="fa fa-arrow-right ms-3"></i></a>
            @endguest

            @auth
            <form action="{{ route('logout') }}" method="POST" style="display: inline;">
                @csrf
                <button type="submit" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">log Out <i class="fa fa-arrow-right ms-3"></i></button>
            </form>
            @endauth
        </div>
    </nav>
